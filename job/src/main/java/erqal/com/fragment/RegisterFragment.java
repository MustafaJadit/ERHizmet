...
public class RegisterFragment extends Fragment {
    ...
    public boolean serviceValidate(int messageCode) {
        if (messageCode == Constants.ACCOUNT_ALREADY_EXIT) {
            message.setText(R.string.register_message_text_login_error_user_conflict);
            return false;
            ...
            message.setText(R.string.register_success);
            return true;
        } else {
            message.setText(R.string.network_error);
            return false;
