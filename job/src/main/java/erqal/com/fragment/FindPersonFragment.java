...
public class FindPersonFragment extends Fragment {
    ...
    private UAutoCompleteTextView uAutoCompleteTextView;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.find_person_fragment, null);
        ButterKnife.bind(this, view);
        uAutoCompleteTextView = (UAutoCompleteTextView)view.findViewById(R.id.searchView);
    ...
    private void getTitle() {
        textView.setText(R.string.findperson);
    }
    public static Fragment getInstance() {
        FindPersonFragment fragment = new FindPersonFragment();
        return fragment;
    }
}
