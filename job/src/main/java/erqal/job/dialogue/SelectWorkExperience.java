 ...
 */
public class SelectWorkExperience extends Dialog implements AdapterView.OnItemClickListener {
    ...
    public SelectWorkExperience(Context context, RefreshUIData refreshActivities) {
        super(context);
    ...
    private void setListener() {
        ...
        mTitle.setText(R.string.select_workexperience);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        refreshActivities.refreshWorkExperience(selected);
        dismiss();
    }
}
