 ...
 */
public class SelectSex extends Dialog implements AdapterView.OnItemClickListener {
    ...
    public SelectSex(Context context, RefreshUIData refreshActivities) {
        super(context);
    ...
    private void setListener() {
        ...
        mTitle.setText(R.string.select_sex);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        refreshActivities.refreshSex(selected);
        dismiss();
    }
}
