...
public class OptionsPopupWindow extends PopupWindow implements OnClickListener {
    ...
    private OnOptionSingleSelect optionSingleSelect;

    public OptionsPopupWindow(Context context, String name) {
        super(context);
        ...
        title = (UTextView) rootView.findViewById(R.id.pv_title);
        title.setText(name);
        // -----确定和取消按钮
...
//        btnCancel.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (tag.equals(TAG_CANCEL)) {
            ...
            } else if (optionSingleSelect != null) {
                int[] optionsCurrentItems = wheelOptions.getCurrentItems();
                optionSingleSelect.onOptionsSelect(optionsCurrentItems[0]);
            }
            dismiss();
            return;
        }
    ...
    public interface OnOptionSingleSelect {
    ...
    public void setOnoptionSingleSelect(OnOptionSingleSelect optionSingleSelect) {
        this.optionSingleSelect = optionSingleSelect;
    }
}
